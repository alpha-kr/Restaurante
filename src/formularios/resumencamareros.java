 ...
 * @author ANDY
 */
public class resumencamareros extends javax.swing.JFrame {

    /**
     * Creates new form cocina
     */
    public resumencamareros() {
        initComponents();
        funciones.user p = funciones.meseros;
       while(p!=null){
       
         m.addRow( new Object[]{p.nombre,p.nummesas});
       p=p.link;
       }
    ...
    DefaultTableModel m = new DefaultTableModel(new Object[][]{}, new Object[]{"Camarero","Numero de mesas"}
    ) {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Ventas Por Camareros");
        jPanel6.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 50, -1, 48));
        ...
        jLabel14.setText(" ");
        jPanel6.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/restaurante/che.png"))); // NOI18N
        jLabel1.setText(" ");
        jPanel6.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 0, 190, 170));
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        int c = tabla.getColumnModel().getColumnIndexAtX(evt.getX());
            ...
            int mesa2 = Integer.parseInt(tabla.getValueAt(r, 1).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(resumencamareros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new resumencamareros().setVisible(true);
            }
        });
    }
