...
public class proviciones extends javax.swing.JFrame {
    ...
    public proviciones() {
        ...
        for (int i = 0; i < funciones.ingre.size(); i++) {
                ...
                m.addRow(new Object[]{funciones.ingre.get(i).getNombre(),funciones.ingre.get(i).getCantidad(),  btn});
    ...
    DefaultTableModel m = new DefaultTableModel(new Object[][]{}, new Object[]{"Ingrediente", "Cantidad", "Pedir" }
    ) {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Proviciones ");
        jPanel6.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 40, -1, 48));
        ...
        jLabel14.setText(" ");
        jPanel6.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 40, -1, -1));
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        if (value instanceof JButton) {
           String num =JOptionPane.showInputDialog(this, "Escriba cantidad a solicitar", "");
            int numero=Integer.parseInt(num);
            if (numero>0) {
                int indice = funciones.indiceingrediente(tabla.getValueAt(r,0 ).toString());
                    JButton btn = new JButton("Pedir");
                funciones.ingre.get(indice).setCantidad(numero+ funciones.ingre.get(indice).getCantidad());
                m.setRowCount(0);
                for (int i = 0; i < funciones.ingre.size(); i++) {
       ...
       funciones.BorrarFichero(ingredientes);
       funciones.sobreescribir(ingredientes);
            ...
            funciones.mostrarmensaje("Digite numero mayor a cero", "Error dijite numero valido ", this);
